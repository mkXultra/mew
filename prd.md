...
- `mew chat` slash commands should expose cockpit controls such as `/add`, `/show`, `/note`, `/why`, `/digest`, `/approve`, `/dispatch`, `/result`, `/wait`, `/review`, `/followup`, `/retry`, `/sweep`, `/pause`, `/resume`, and `/mode`.
