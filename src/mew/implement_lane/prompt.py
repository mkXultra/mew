        ...
        sections.append(
            PromptSection(
                ...
                content=(
                    ...
                    "source command such as `rg --files` plus focused searches for artifact/output path "
                    "terms like frame, screenshot, output, save, /tmp, .bmp, .png, .log, and platform hook "
                    "names. Treat source-declared output paths and stdout markers as authoritative "
