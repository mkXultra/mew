    ...
    sections = [
        ...
        PromptSection(
            ...
            content=(
                ...
                "and blocker class are enough to act. Keep normal source mutation on "
                "write/edit/apply_patch paths. For large generated files where embedding the full "
                "file in a JSON tool call is the bottleneck, use one bounded run_command writer as "
                "the source mutation; mew will track the source-tree mutation and still requires a "
                "later verifier. Use run_command otherwise for probes, builds, runtime execution, "
                "and verification. "
