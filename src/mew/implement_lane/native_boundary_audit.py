...
SOURCE_CONTROL_SPECS: tuple[SourceControlSpec, ...] = (
    ...
    SourceControlSpec(
        name="provider_visible_finish_absent_tool_profiles",
        relative_path="src/mew/implement_lane/tool_profiles/mew_legacy.py",
        anchor="MEW_LEGACY_TOOL_SPECS",
        markers=("MEW_LEGACY_TOOL_SPECS",),
