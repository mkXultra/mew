...
def _build_work_think_prompt_legacy(context):
    return (
        ...
        "For runtime frame, screenshot, or image-output tasks, artifact existence, nonzero pixels, valid headers, or self-consistent dimensions are not enough; cite a completed tool that checks expected dimensions/resolution, reference similarity, or explicit expected-output markers before finish. "
