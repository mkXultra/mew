...
def build_parser():
    ...
    self_improve_parser = subparsers.add_parser(
        ...
        epilog=(
            ...
            "    prints concrete continue/follow/status/resume/chat controls for the task\n"
            "  mew self-improve --start-session --json --focus \"Make the coding cockpit calmer\"\n"
            "    returns controls.continue, controls.follow, controls.status, controls.resume, controls.chat\n"
