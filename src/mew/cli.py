...
def build_parser():
    ...
    do_parser.add_argument("--prompt-approval", action="store_true", help="prompt inline before applying dry-run writes")
    ...
    work_parser.add_argument("--prompt-approval", action="store_true", help="prompt inline before applying dry-run writes in --live mode")
