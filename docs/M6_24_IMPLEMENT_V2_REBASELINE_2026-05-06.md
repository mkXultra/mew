...
- `polyglot-c-py` speed proof
  ...
  scored external reward `1.0` with runner exceptions `0`, `work_exit_code=0`,
  `stop_reason=finish`, native pairing valid, normalized trace total
  `333.842s`, total runtime about `7m17s`, `model_turns=25`,
  `tool_calls=24`, `tool_results=24`, and
  `first_source_mutation_seconds=39.494`. The run is also behavioral evidence
  for the Codex-like base instruction alignment: after compiling a temporary
...
- `pypi-server` speed proof
  ...
  scored external reward `1.0` with runner exceptions `0`, `work_exit_code=0`,
  native pairing valid, normalized trace total `123.491s`, total runtime about
  `3m30s`, `message_count=11`, `tool_call_completed_count=11`, and
  `first_source_mutation_seconds=21.359`. The finish verifier planner selected
...
- `raman-fitting` speed proof
  ...
  failed Codex trace as a successful reference-step target. Classification:
  ...
  task-specific repair or a new numeric/scientific objective-grounding
  substrate. This matches prior SR-005 / Batch 1 guidance: do not spend another
...
- `schemelike-metacircular-eval` speed proof
  ...
  scored external reward `1.0` with runner exceptions `0`,
  `work_exit_code=0`, `stop_reason=finish`, native pairing valid, normalized
  trace total `1315.698s`, total runtime about `26m27s`, `model_turns=105`,
  `tool_calls=104`, `tool_results=104`, first tool at `2.256s`, first edit at
