...
| `verified_sibling_repair_frontier_not_exhausted` | `docs/M6_24_DOSSIER_BUILD_CYTHON_EXT_2026-05-03.md` | `build-cython-ext`; future related family: native-extension/package compatibility tasks | active | Read the dossier before another verifier-sibling, repository-test-tail, or near-solution compatibility repair. |
