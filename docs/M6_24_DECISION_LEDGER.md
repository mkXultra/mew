...
`M6.24 -> hard_task_implementation_strategy_contract_retention -> deferred_verify_runtime_artifact_cleanup_report_fallback_missing -> speed_1 passed -> proof_5 rerun make-mips-interpreter`
