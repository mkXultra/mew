...
`M6.24 -> hard_task_implementation_strategy_contract_retention -> hard-runtime verifier strategy rerun recorded -> repair runtime_artifact_cleanup_external_verifier_alignment -> rerun make-doom-for-mips same shape`
