...
`M6.24 -> hard_task_implementation_strategy_contract_retention -> runtime artifact freshness rerun recorded -> hard_task profile v0 recorded -> repair hard_runtime_final_verifier_state_transfer -> speed-rerun make-doom-for-mips same shape first`
