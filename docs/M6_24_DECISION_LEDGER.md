...
`M6.24 -> hard_task_implementation_strategy_contract_retention -> runtime_artifact_freshness_discovered_artifact repaired -> speed_1 rerun make-mips-interpreter`
