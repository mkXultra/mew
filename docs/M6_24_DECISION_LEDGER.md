...
`M6.24 -> hard_task_implementation_strategy_contract_retention -> deferred_verify_runtime_artifact_cleanup_on_timeout repaired -> speed_1 rerun make-mips-interpreter`
