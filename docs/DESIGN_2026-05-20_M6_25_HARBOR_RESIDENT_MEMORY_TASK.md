# Design 2026-05-20 - M6.25 Harbor Resident Memory Task

Status: design only.

Scope: define the first Harbor-compatible resident-memory benchmark task family
for M6.25. This document does not implement task fixtures, source code, runner
changes, or roadmap/status edits.
