...
```bash
./mew dogfood --scenario m4-file-write-recovery --workspace proof-workspace/mew-proof-m4-file-write-recovery-local-20260420-1118 --json
```
...
Runtime effects, shell commands, rollback-required writes, and broader passive
auto-recovery remain future work.
