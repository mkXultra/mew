...
- `uv run pytest -q` current: `858 passed, 6 subtests passed`.
...
- `uv run pytest -q experiments/mew-desk` current: `9 passed`, including the isolated terminal-pet renderer over `mew desk --json`.
