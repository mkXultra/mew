...
| 6.24 Broad Terminal-Bench Parity Campaign | `in_progress` | Batch 5 `bn-fit-modify` reached 5/5; continue with `circuit-fibsqrt`. |
...
- Run M6.24 Batch 5 task-by-task from
  ...
  `{max_wall_seconds_option}` run shape. Next task: `circuit-fibsqrt`. If a new
