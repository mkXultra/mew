...
- The documented 20-slice bounded calibration batch has started on literal
  ...
  on HEAD `be91d3b`. Continue the batch from a fresh small paired surface,
  with codex-ultra review per phase, until the 20-slice / 50% incidence
  criterion can be compared or a concrete fix-first blocker appears.
