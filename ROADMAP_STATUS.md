...
- scaling the repeated-task proof matrix or introducing the small runner/report
  structure needed to track multiple proof shapes without inflating the close
  gate;
