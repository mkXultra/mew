...
| 6.24 Broad Terminal-Bench Parity Campaign | `in_progress` | Batch 5 is complete at 31/40 vs Codex 40/40; select Batch 6 from remaining frozen registry tasks. |
...
- Select M6.24 Batch 6 from the remaining frozen registry tasks, preserving the
  no-Terminal-Bench-specific-solver rule and the current aligned run shape. If
  a new accepted structural blocker appears, append it to
