...
| 6.9. Durable Coding Intelligence | `in_progress` | Phase 1 substrate plus eight post-M6.12 proof/report/substrate slices landed; repeated-task recall now covers seven deterministic shapes with per-shape matrix reporting, but the 10-shape gate and comparator rerun are still open. |
...
- M6.9 resumed on 2026-04-25 after the clean pause boundary served its
  ...
  have landed, and the repeated-task proof matrix has 7/10 deterministic shapes
...
- continue scaling the repeated-task proof matrix beyond the current 7/10
