...
and a time-dilated resident-loop smoke proof. The 5.11 AgentMemorySnapshot path
is now started as a minimal save/load skeleton for closed work sessions. This
is enough to make M3 materially
