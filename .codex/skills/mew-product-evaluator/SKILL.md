...
- 5.12 has started as a file-backed typed/scoped memory MVP. The next product question is whether those memories affect resident behavior automatically; a small active recall injection is more valuable than adding more memory storage surfaces.
